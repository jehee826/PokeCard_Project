    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth /* 어떤 주소로 들어오는 요청을 허용하거나 막을지 정함 */
                .requestMatchers("/api/public/**", "/api/main/ai", "/api/main/ency","/api/market/alllist","/pokemon/**", "/api/market/sellerlist"/*, "/api/market/detail/**","/api/market/**"*/).permitAll() /* 로그인이나 회원가입 페이지 /api/auth/** 은 모두 허용 */
